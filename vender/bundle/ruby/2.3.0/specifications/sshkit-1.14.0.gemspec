...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rbnacl>, ["~> 3.4"])
      s.add_development_dependency(%q<rbnacl-libsodium>, [">= 0"])
    else
      ...
      s.add_dependency(%q<rbnacl>, ["~> 3.4"])
      s.add_dependency(%q<rbnacl-libsodium>, [">= 0"])
    end
  else
    s.add_dependency(%q<net-ssh>, [">= 2.8.0"])
    s.add_dependency(%q<net-scp>, [">= 1.1.2"])
